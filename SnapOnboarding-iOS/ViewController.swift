...
class ViewController: UIViewController {
    ...
    func createSampleViewModelNorwegian() -> SnapOnboardingViewModel {
        ...
        introViewModel.tags = createTagRepresentationsForStrings(
            ["Veske", "MichaelKors", "JetSetTravel", "Skinn", "Beige", "Accessoirer", "MØBLER", "DEKORASJON", "ELEKTRONIKK", "JAKKE", "BØKER", "ZARA", "SOLBRILLER", "GANT"]
        )
    ...
    func createSampleViewModelEnglish() -> SnapOnboardingViewModel {
        ...
        introViewModel.tags = createTagRepresentationsForStrings(
            ["Purse", "MichaelKors", "JetSetTravel", "Leather", "Beige", "Accessories", "FURNITURE", "DECORATIONS", "ELECTRONICS", "JACKET", "BOOKS", "ZARA", "SUNGLASSES", "GANT"]
        )
